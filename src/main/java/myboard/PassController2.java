...
public class PassController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/admin/Pass2.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(confirmed) {
			...
			if(mode.equals("edit")) {
				...
				resp.sendRedirect("../myboard/edit2.do?idx="+ idx);
			}
				...
				JSFunction.alertLocation(resp, "삭제되었습니다.", "../myboard/list2.do");
