...
public class JSFunction {
	...
	public static void alertLocation(String msg, String url, JspWriter out) {
		...
		/*
		Java클래스에서 JSP의 내장객체를 사용할 수 없으므로 반드시 매개변수로
		전달받아 사용해야 한다.
    ...
    /*
    앞의 2개의 메서드는 JSP에서 out 내장객체를 통해 Javascript 함수를 실행한다.
    아래는 서블릿에서 JS함수를 실행하기 위해 작성되므로 out 내장객체 대신 
    response내장객체를 통해 컨텐츠 타입을 설정한 후 JS코드를 출력한다.
     */
