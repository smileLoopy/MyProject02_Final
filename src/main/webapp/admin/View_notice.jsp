...
<head>
<meta charset="UTF-8">
<title>상세보기 View_notice 어드민쪽</title>
<!-- BootStrap CDN -->
...
<table class="table table-striped">
    ...
    <tr>
        <td colspan="4" align="center">
            ...
            <button class="btn btn-outline-dark" type="button" onclick="location.href='../mynotice/pass_notice.do?mode=edit&idx=${param.idx}';">
                수정하기
            </button>
            <button class="btn btn-outline-dark" type="button" onclick="location.href='../mynotice/pass_notice.do?mode=delete&idx=${param.idx}';">
                삭제하기
            </button>
            <button class="btn btn-outline-dark" type="button" onclick="location.href='../mynotice/list_notice.do';">
                목록 바로가기
            </button>
        </td>
    </tr>
